  ...
  <div class="user-info">
    ...
    <el-form label-width="220px">
      ...
      <el-row class="inline-info" type="flex" justify="center">
        <el-col :span="12">
          <el-button type="primary" @click="setUpdata">保存更新</el-button>
    ...
    <el-form label-width="220px">
      ...
      <div class="block">
        ...
        <el-row class="inline-info" type="flex" justify="center">
          <el-col :span="12">
            <el-button type="primary" @click="onSaveEmployInfo"
              >保存更新</el-button
            >
            <el-button @click="$router.back()">返回</el-button>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    async setUpdata() {
      await setUserDetail(this.userInfo)
      this.$message.success('更新成功')
    },
    async onSaveEmployInfo() {
